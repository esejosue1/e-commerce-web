...
urlpatterns = [
    ...
    path('remove_shoppingcart/<int:product_id>/',  # url path for when a product is remove from the shopping cart
         views.remove_shoppingcart, name='remove_shoppingcart'),
    path('delete_shoppingcart/<int:product_id>/',  # url path for when a product is deleted from the shopping cart
